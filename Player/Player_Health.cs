...
public class Player_Health : MonoBehaviour
{
   ...
   public  void TakeDamage(float damage) { healthAmounth -= damage; HealthBar.fillAmount = healthAmounth / 100; }
     
    void Die() { if (healthAmounth <= 0) { animator.SetBool("isDead", true);  } }
}
